                ...
                <Grid container marginTop={'1rem'} style={{ height: '100%' }}>
                  ...
                  <Grid item xs={10} sm={11}>
                    <Stack spacing={-1} sx={{ alignItems: 'flex-start' }}>
                      ...
                      <TextField fullWidth className='custom-outlined-input' inputRef={dateReceivedRef} sx={{ borderRadius: '11px' }} defaultValue={props.datereceived } variant='standard' disabled={props.activity !== 'Update'} />
                    </Stack>
                  </Grid>
                  <Grid item xs={10} sm={6}>
                    <Stack spacing={-1} sx={{ alignItems: 'flex-start' }}>
                  ...
                  <Grid item xs={10} sm={6}>
                    <Stack spacing={-1} sx={{ alignItems: 'flex-start' }}>
                      ...
                      <OutlinedInput className='custom-outlined-input' sx={{ borderRadius: '11px', width: "305px" }} defaultValue={props.inspectiondate } inputRef={dateInspectionRef} disabled={props.activity !== 'Update'} />
                    </Stack>
                  </Grid>
                  <Grid item xs={10} sm={6}>
                    <Stack spacing={-1} sx={{ alignItems: 'flex-start' }}>
